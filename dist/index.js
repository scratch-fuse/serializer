...
__export(index_exports, {
  deserializeAllFunctions: () => deserializeAllFunctions,
  deserializeAllScripts: () => deserializeAllScripts,
...
function deserializeFunction(workspace) {
  ...
  const argumentTypes = (0, import_utility.parseProccodeArgumentTypes)(proccode);
